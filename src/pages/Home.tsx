          ...
          <div className="bg-white shadow overflow-hidden sm:rounded-lg mb-6">
            <div className="px-4 py-5 sm:px-6">
              ...
              <p className="mt-1 max-w-2xl text-sm text-gray-500">
                You have successfully authenticated with AWS Cognito SSO.
              </p>
            </div>
          </div>
              ...
              <div className="border-t border-gray-200">
                <dl>
                  ...
                  <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                      {user["cognito:groups"] &&
                      user["cognito:groups"].length > 0 ? (
                        <div className="flex flex-wrap gap-2">
                          {user["cognito:groups"].map((group) => (
                            <span
                              key={group}
            ...
            <div className="px-4 py-5 sm:p-6">
              ...
              <div className="border-4 border-dashed border-gray-200 rounded-lg p-12 text-center">
                ...
                <p className="text-sm text-gray-400 mt-2">
                  This is where your protected content would go
                </p>
              </div>
            </div>
          </div>
